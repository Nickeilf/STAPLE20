...
def load_model_ensemble(filenames, arg_overrides=None, task=None, strict=True, retain_dropout=False):
...
def load_model_ensemble_and_task(filenames, arg_overrides=None, task=None, strict=True, retain_dropout=False):
